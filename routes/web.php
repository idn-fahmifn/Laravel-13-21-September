...
Route::get('halaman-barang', [HalamanController::class, 'barang'])->name('index.barang');
Route::get('halaman-barang/{param}', [HalamanController::class, 'detail'])->name('index.detail');
